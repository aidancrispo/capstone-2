...
$results = $mysqli->query("SELECT  PROD_ID, PROD_Name, PROD_Price, PROD_InStock, PROD_Img FROM products  WHERE PROD_Category='Accessories' ORDER BY PROD_ID ASC LIMIT 10");
if($results){
