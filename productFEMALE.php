...
$con=mysqli_connect("localhost","root","","orderingsystem");
        ...
        //Going to first page
        echo "<center><a href='productFEMALE.php'>"."[First Page] " . "</a>";

        for ($i=1; $i<=$total_pages; $i++) {
        echo "<a href='productFEMALE.php?page=".$i."'>".$i."</a>";
        echo " ";
        };
        // Going to last page
        echo "<a href='productFEMALE.php?page=$total_pages'>".' [Last Page]'."</a></center> ";
        ?>
                </div>
                <!-- Products List End -->
