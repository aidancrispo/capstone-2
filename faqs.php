	    ...
	    <div id="templatemo_menu" class="ddsmoothmenu">
	        <ul>
	            ...
	            <li><a href="Products.php">Products</a></li>
							<li><a href="aboutMore.php">About</a></li>
    	...
    	<div id="sidebar">
				<h3>Categories</h3>
					<ul class="sidebar_menu">
						...
						<!-- <li><a href="productLCDRacks.php">LCD TV Racks</a></li>
						<li><a href="productAC.php">AC Outdoor Unit Wall Bracket</a></li>
						<li><a href="productMC.php">Multimedia Cables</a></li>
						<li><a href="productCS.php">Cable Splitters/Distributors</a></li>
						<li><a href="productPMS.php">Portable Media Storage</a></li> -->
					</ul>
			<h3>Newsletter</h3>
			<p>Enter E-Mail for subscription.</p>
			<div id="newsletter">
					<form action="#" method="get">
