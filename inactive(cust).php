...
<div class="container">
  <div class="col-md-2">
    <div class="list-group">
      ...
      <a href="inactive(cust).php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>  Inactive Customers <span class='badge'></span></a>
    </div>
  ...
  <div class="col-md-10">
    <div class="accounts">
        ...
        <h1 class="accountstext">Inactive Customers</h1>
        ...
        <div id="table" class="table-editable">
            <table class="table">
                <tr>
                    ...
                    $sql = "SELECT ACNTS_ID,ACNTS_UName FROM accounts WHERE ACNTS_Role = 'Customer' AND ACNTS_Status = 'Inactive' LIMIT $start_from,$per_page";
