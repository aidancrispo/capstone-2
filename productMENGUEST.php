...
$results = $mysqli->query("SELECT  PROD_ID, PROD_Name, PROD_Price, PROD_InStock, PROD_Img FROM products  WHERE PROD_Category='Men' ORDER BY PROD_ID ASC LIMIT $start_from,$per_page");
if($results){
...
$con=mysqli_connect("localhost","root","","orderingsystem");
        ...
        $query = "select * from products WHERE PROD_Category='Men'";
        ...
        //Going to first page
        echo "<center><a href='productMENEGUEST.php'>"."[First Page] " . "</a>";

        for ($i=1; $i<=$total_pages; $i++) {
        echo "<a href='productMENGUEST.php?page=".$i."'>".$i."</a>";
        echo " ";
        };
        // Going to last page
        echo "<a href='productMENGUEST.php?page=$total_pages'>".' [Last Page]'."</a></center> ";
        ?>
                </div>
                <!-- Products List End -->
