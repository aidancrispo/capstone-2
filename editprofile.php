                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" disabled placeholder="Username" value=<?php echo $_SESSION['username']; ?> ><br><br>
                                                </div>
                                                <div class="form-group">
                                                    <label><b>Account ID: &nbsp;</b></label>
                                                    <input type="text" class="form-control" disabled placeholder="Account Id" value=<?php echo $_SESSION['id']; ?> ><br><br>
                                                </div>
                                            </div>
                                            <?php
																include ('test.php');
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" name="email" required value=<?php echo $row['CUST_Email']; ?> ><br><br>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="te xt" class="form-control" placeholder="Full Name" name="name" required value="<?php echo $row['CUST_Name'] ?>"><br><br>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" class="form-control" placeholder="Contact Number" name="contactno" required data-error='NEW ERROR MESSAGE' value="<?php echo $row['CUST_ContactNO'] ?>"><br><br>
                                                    <hr>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" class="form-control" placeholder="Address" name="Address" required style='width:500px'><?php echo $row['CUST_Address'] ?></textarea><br><br>
                                                </div>
                                            </div>
                                        </div>
