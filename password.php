              ...
              <div class="container">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                      ...
                      <ul class="nav navbar-nav navbar-justified">
                          ...
                          <li><a href="home.php#features">Products</a></li>
...
<div class="row">
  <div class="col-md-2">
      ...
      <div class="col-md-8">
          <div class="card">
              <div class="header">
                  <h4 class="title"><center>You have successfully reset your password!</center></h4><hr>
              </div>
              <div class="content">
                      <div class="row">
                          <div class="text-center">
                              <div class="form-group">
                                  <label>Your New Password is:</label><br>
                                    <?php
                                    session_start();
                                    ?>
                                  <p><input type="name"  class="text-center" disabled value="<?php echo $_SESSION['password']?>"></p>
                              </div>
                          </div>
                      </div>

                      <center><a id="modal_triggertwo" href="#modaltwo"><button class="btn btn-info btn-fill">Login</button></a></center>
...
<!-- Login -->
            ...
            <div class="user_login">
                <form action="homelogin.php" method="post">
                    ...
                    <div class="action_btns">
                        <center><div class="one_half last"><input type="submit" name="Submit" VALUE="Login" class="btn btn_red"></div></center>
    ...
    <div id="modaltwo" class="popupContainer" style="display:none;">
        <header class="popupHeader">
            <span class="header_title">Login</span>
            <span class="modal_close"><i class="fa fa-times"></i></span>
        </header>
...
<script type="text/javascript">
    ...
    $("#modal_triggertwo").leanModal({top : 150, overlay : 0.6, closeButton: ".modal_close" });
</script>
