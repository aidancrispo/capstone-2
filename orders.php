...
Table Codes
 !-->
    ...
    <div>
        ...
        <div style="overflow-y: auto;" class="table-responsive-vertical shadow-z-1">
            <!-- Table starts here -->
    ...
    . "finalorders ON accounts.ACNTS_ID = finalorders.ACNTS_ID ORDER BY FIELD (finalorders.Status,'Pending','Processing','Delivered','On Hold','Completed','Cancelled')";
