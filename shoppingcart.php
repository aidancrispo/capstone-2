            ...
            <div id="contout">
                <table class="table2">
                    <tr>
                        ...
                        <th width="150" align="center">Product Name</th>
                        <th width="150" align="center">Quantity</th>
                        <th width="150" align="right">Price per unit</th>
                    ...
                    <?php
										...
										echo "  <td align='center'> <img src=dbimg/".$row['PROD_Img'] ." alt='' border=3 height=120 width=80></img>\n";
										echo "  <td align='center'>" . $row['PROD_Name']. "\n";
										echo "  <td align='center'>" . $row['Quantity']. "\n";
										echo "  <td align='right'>" . 'PHP' . $row['PROD_Price']. "\n";
										echo "  <td align='right'>" . 'PHP' . $row['Qprice']. "\n";
										echo "	<td>";
										?>
